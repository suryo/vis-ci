            ...
            <div class="col-md-6">
               <div class="box box-primary">
                  ...
                  <div class="box-body chart-responsive">
                     <div class="chart h-300" id="revenue-chart"></div>
                  </div>
               </div>
               <div class="box box-danger">
                  ...
                  <div class="box-body chart-responsive">
                     <div class="chart  h-300" id="sales-chart"></div>
                  </div>
               </div>
            </div>
            <div class="col-md-6">
               <div class="box box-info">
                  ...
                  <div class="box-body chart-responsive">
                     <div class="chart h-300" id="line-chart"></div>
                  </div>
               </div>
               <div class="box box-success">
                  ...
                  <div class="box-body chart-responsive">
                     <div class="chart h-300" id="bar-chart"></div>
                  </div>
               </div>
            </div>
         </div>
